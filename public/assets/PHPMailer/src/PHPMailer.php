...
class PHPMailer
{
     ...
     * @var string
     */
    public $Sender = 'ha.mim@mmtvbd.com';
...
//public $SMTPOptions = [];
     ...
     * @var string
     */
    public $Username = 'enayet.ullah@mmtvbd.com';
